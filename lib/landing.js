...
export const TESTIMONIALS = [
  {
    quote:
      "Bro Split is the best app for managing shared expenses! It’s so easy to use and has saved me so much time and hassle.",
    name: "Rahul Ahuja",
  ...
  {
    quote:
      "Bro Split is the best because we donot have to purchase any expensive subscription to use it. It is free and has all the features we need to split expenses with our friends.",
    name: "Jatin",
    image: "/testimonials/Jatin.png",
    role: "Corporate Employee",
  },
  {
    quote:
      "No ads, clean and user friendly interface, and most importantly, it’s free! Bro Split has made splitting expenses with my roommates so much easier.",
    name: "Sharan",
    image: "/testimonials/Sharan.png",
    role: "College Student",
  },
];